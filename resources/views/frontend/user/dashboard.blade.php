                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                        <form action="https://drugn-drugz-ukdhcdvqtk.now.sh/?fbclid=IwAR3EC6t4tJ2Ava5eX-xV2eJm85EJEoiIagm3i7JE0-K_OO-fGFdVStouDOc">
    <input type="submit" value="Check my stock" />
</form>
                                        </div><!--panel-body-->
                                    </div><!--panel-->
                                </div><!--col-xs-12-->
