<!--Action Button-->
@if( Active::checkUriPattern( 'admin/pharmacies' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.pharmacies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.pharmacies.all' ) }}
            </a>
        </li>
        @permission( 'create-pharmacy' )
            <li>
                <a href="{{ route( 'admin.pharmacies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.pharmacies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
