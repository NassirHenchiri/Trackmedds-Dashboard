<!--Action Button-->
@if( Active::checkUriPattern( 'admin/providers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.providers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.providers.all' ) }}
            </a>
        </li>
        @permission( 'create-provider' )
            <li>
                <a href="{{ route( 'admin.providers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.providers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
