<!--Action Button-->
@if( Active::checkUriPattern( 'admin/mypharmacies' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.mypharmacies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.mypharmacies.all' ) }}
            </a>
        </li>
        @permission( 'create-mypharmacy' )
            <li>
                <a href="{{ route( 'admin.mypharmacies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.mypharmacies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
