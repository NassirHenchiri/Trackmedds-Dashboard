<!--Action Button-->
@if( Active::checkUriPattern( 'admin/allpharmacies' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.allpharmacies.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.allpharmacies.all' ) }}
            </a>
        </li>
        @permission( 'create-allpharmacy' )
            <li>
                <a href="{{ route( 'admin.allpharmacies.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.allpharmacies.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
