<!--Action Button-->
@if( Active::checkUriPattern( 'admin/commandes' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.commandes.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.commandes.all' ) }}
            </a>
        </li>
        @permission( 'create-commande' )
            <li>
                <a href="{{ route( 'admin.commandes.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.commandes.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
