                ...
                <table id="products-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.backend.products.table.nproduct') }}</th>
                            <th>{{ trans('labels.backend.products.table.featured_image') }}</th>
                            <th>{{ trans('labels.backend.products.table.status') }}</th>
                            <th>{{ trans('labels.backend.products.table.quantité') }}</th>
                            <th>PRICE TND</th>
        ...
        $(function() {
            ...
            var dataTable = $('#products-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'nproduct', name: '{{config('module.products.table')}}.nproduct'},
                    {data: 'featured_image', name: '{{config('module.products.table')}}.featured_image'},
                    {data: 'status', name: '{{config('module.products.table')}}.status'},
                    {data: 'quantité', name: '{{config('module.products.table')}}.quantité'},
                    {data: 'price', name: '{{config('module.products.table')}}.price'},
                    {data: 'created_at', name: '{{config('module.products.table')}}.created_at'},
                    {data: 'created_at', name: '{{config('module.products.table')}}.updated_at'},
