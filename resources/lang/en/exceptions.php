...
return [
	...
	"mypharmacies" => [
	"already_exists" => "That Mypharmacy already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Mypharmacy. Please try again.",
	"delete_error" => "There was a problem deleting this Mypharmacy. Please try again.",
	"not_found" => "That Mypharmacy does not exist.",
	"update_error" => "There was a problem updating this Mypharmacy. Please try again.",
	],
	"permissions" => [
	...
	"commandes" => [
	"already_exists" => "That Commande already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Commande. Please try again.",
	"delete_error" => "There was a problem deleting this Commande. Please try again.",
	"not_found" => "That Commande does not exist.",
	"update_error" => "There was a problem updating this Commande. Please try again.",
	],
	"pharmacies" => [
	"already_exists" => "That Pharmacy already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Pharmacy. Please try again.",
	"delete_error" => "There was a problem deleting this Pharmacy. Please try again.",
	"not_found" => "That Pharmacy does not exist.",
	"update_error" => "There was a problem updating this Pharmacy. Please try again.",
	],
	"stocks" => [
	"already_exists" => "That Stock already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Stock. Please try again.",
	"delete_error" => "There was a problem deleting this Stock. Please try again.",
	"not_found" => "That Stock does not exist.",
	"update_error" => "There was a problem updating this Stock. Please try again.",
	],
	"roleusers" => [
	"already_exists" => "That RoleUser already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this RoleUser. Please try again.",
	"delete_error" => "There was a problem deleting this RoleUser. Please try again.",
	"not_found" => "That RoleUser does not exist.",
	"update_error" => "There was a problem updating this RoleUser. Please try again.",
	],
	"allpharmacies" => [
	"already_exists" => "That Allpharmacy already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Allpharmacy. Please try again.",
	"delete_error" => "There was a problem deleting this Allpharmacy. Please try again.",
	"not_found" => "That Allpharmacy does not exist.",
	"update_error" => "There was a problem updating this Allpharmacy. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
